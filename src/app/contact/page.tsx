...
export const metadata = {
  title: "Contact Peak Performance Physical Therapy | CO 80302",
  description: "Get in touch with Peak Performance Physical Therapy. Call (303) 555-7890 or fill out our contact form. We'd love to hear from you.",
};
